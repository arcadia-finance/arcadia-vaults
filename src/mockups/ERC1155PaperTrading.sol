...
contract ERC1155PaperTrading is ERC1155Mock {
  ...
  constructor(string memory name, string memory symbol, address _tokenShop) ERC1155Mock(name, symbol) {
    tokenShop =_tokenShop;
  }

  function mint(address to, uint256 id, uint256 amount) public override onlyTokenShop {
    _mint(to, id, amount, "");
  }
