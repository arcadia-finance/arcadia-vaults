...
contract FactoryPaperTradingInheritedTest is factoryTest {
    ...
    ArcadiaOracleFixture public arcadiaOracleFixture = new ArcadiaOracleFixture(address(1));
    ...
    constructor() factoryTest() {
        ...
        oracleStableUsdToUsd = arcadiaOracleFixture.initStableOracle(uint8(Constants.oracleStableToUsdDecimals), "masUSD / USD", address(123));
