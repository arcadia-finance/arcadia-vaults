...
contract gasVaultAuction_1ERC201ERC721 is DSTest {
  ...
  function setUp() public {
    ...
    uint256 valueBayc = 10 ** 18 * rateWbaycToEth * rateEthToUsd / 10 ** (Constants.oracleWbaycToEthDecimals + Constants.oracleEthToUsdDecimals) * s_3[1];
