...
contract gasVaultAuction_1ERC20 is DSTest {
  ...
  function setUp() public {
    ...
    vm.prank(vaultOwner);
    uint256 valueEth = 10 ** 18 * rateEthToUsd / 10 ** Constants.oracleEthToUsdDecimals * s_assetAmounts[0] / 10 ** Constants.ethDecimals;
