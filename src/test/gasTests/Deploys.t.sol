...
factory.setLiquidator(address(liquidator));
  ...
  function testDeployMainRegistry() public {
    new MainRegistry(MainRegistry.NumeraireInformation({numeraireToUsdOracleUnit:0, assetAddress:0x0000000000000000000000000000000000000000, numeraireToUsdOracle:0x0000000000000000000000000000000000000000, numeraireLabel:'USD', numeraireUnit:1}));
  }
  ...
  function testDeploySubRegistryERC1155() public {
    new TestERC1155SubRegistry(address(mainRegistry), address(oracleHub));
  }
