...
contract gasDeploys is DSTest {
  ...
  function testDeployMainRegistry() public {
    new MainRegistry(MainRegistry.NumeraireInformation({numeraireToUsdOracleUnit:0, assetAddress:0x0000000000000000000000000000000000000000, numeraireToUsdOracle:0x0000000000000000000000000000000000000000, stableAddress:address(stable), numeraireLabel:'USD', numeraireUnit:1}));
  }
  ...
  function testDeployInterestRateModule() public {
    new InterestRateModule();
  }
