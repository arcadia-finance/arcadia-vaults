...
contract BaseCurrencyManagementTest is MainRegistryTest {
    ...
    function testRevert_addBaseCurrency_WrongNumberOfRiskVariables() public {
        // Given: collateralFactors index 0, 1 and 2 is collFactor, liquidationThresholds index 0, 1 and 2 is liqTresh, creatorAddress calls addPricingModule and addAsset
...
contract RiskVariablesManagementTest is MainRegistryTest {
    ...
    function testRevert_batchSetRiskVariables_NonOwner(address unprivilegedAddress_) public {
        ...
        vm.startPrank(unprivilegedAddress_);
        // When: unprivilegedAddress_ calls batchSetRiskVariables for assetAddresses, baseCurrencies,  riskVars
    ...
    function testRevert_batchSetRiskVariables_NonEqualInputLists() public {
        ...
        vm.startPrank(creatorAddress);
        // When: creatorAddress calls batchSetRiskVariables for assetAddresses, baseCurrencies,  riskVars
    ...
    function testSuccess_batchSetRiskVariables() public {
        ...
        (uint16 collateralFactor, uint16 liquidationThreshold) =
            standardERC20PricingModule.assetRiskVars_(address(eth), 0);

        assertEq(RiskConstants.DEFAULT_COLLATERAL_FACTOR, collateralFactor);
        assertEq(RiskConstants.DEFAULT_LIQUIDATION_THRESHOLD, liquidationThreshold);
    }
}
